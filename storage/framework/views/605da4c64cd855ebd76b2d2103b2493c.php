...
<section class="pt-5 d-flex align-items-center justify-content-center" style="min-height: 90vh">
    <div class="m-auto pt-5" style="max-width: 400px">
        ...
        <div class="tab-content espaco_tab">
            <form class="row g-3" action="<?php echo e(route('usuario.recebe-registro')); ?>" method="POST" id="pesquisaForm">
                <?php echo csrf_field(); ?>
            ...
            <div class="d-flex justify-content-center mt-5">
                <a href="<?php echo e(route('login')); ?>" class="text-danger">Já tenho conta</a>
            </div>
        </div>
    </div>
</section>
<!-- End Search Form Section -->
<?php /**PATH /home/cnfbr/laravel_teste/resources/views/usuario/forms/registro.blade.php ENDPATH**/ ?>