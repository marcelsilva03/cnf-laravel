<script>
    ...
    const obtemDadosProduto = () => {
        return {
            codigo: "<?php echo e($solicitacao['pag_code']); ?>",
            nomeSolicitante: "<?php echo e($solicitacao['sol_nome_sol']); ?>",
            telefone: "<?php echo e($solicitacao['sol_tel_sol']); ?>",
            email: "<?php echo e($solicitacao['sol_email_sol']); ?>",
            produto: "<?php echo e($solicitacao['produto']); ?>",
            valor: "<?php echo e($solicitacao['sol_valor']); ?>",
        }
    };
    ...
    try {
        // 1) ambiente via SDK
        const efiEnv = '<?php echo e(config('efipay.options')['sandbox'] ? 'sandbox' : 'production'); ?>';
    ...
    const efiAccount = '<?php echo e(env("EFI_ACCOUNT_IDENTIFIER")); ?>';
    ...
    try {
        ...
        .setAccount(efiAccount)
        .setEnvironment('<?php echo e(config('efipay.options')['sandbox'] ? 'sandbox' : 'production'); ?>')
        .setBrand(brand)
        <?php $valorInteiro = intval(preg_replace('/\D/', '', $solicitacao['sol_valor'])); ?>
        .setTotal(<?php echo e($valorInteiro); ?>)
        .getInstallments();
...
// helpers de UI para erro
    ...
    const sucessoUrl = "<?php echo e(route('pagamento.sucesso')); ?>";
    ...
    (function () {
        ...
        botao.addEventListener('click', async () => {
            ...
            enviaDadosParaServidor(
                payload,
                '<?php echo e(route("api-pagamentos.efi.recebe-cartao")); ?>',
                callbackCartao,
                callbackErro
            );
        });
    ...
    (function () {
        ...
        botaoBoleto.addEventListener('click', () => {
            ...
            enviaDadosParaServidor(
                payload,
                '<?php echo e(route("api-pagamentos.efi.recebe-boleto")); ?>',
                (response) => {
    ...
    botaoBB.addEventListener('click', () => {
        ...
        enviaDadosParaServidor(dados, "<?php echo e(route('api-pagamentos.bb.pix-ou-ted')); ?>", callbackBB, callbackErro);
    });
    ...
    const code   = <?php echo json_encode($solicitacao['pag_code'], 15, 512) ?>;
    ...
    function mostrarPago(d) {
        ...
        const sucessoUrl = "<?php echo e(route('pagamento.sucesso')); ?>";
        const params = new URLSearchParams({
            codigo: d?.code || <?php echo json_encode($solicitacao['pag_code'], 15, 512) ?>, // fallback
            status: 'approved',
    ...
    const gerarQRCode = () => {
        const dados = obtemDadosProduto();
        const url = '<?php echo e(route("api-pagamentos.efi.gera-qrcode")); ?>';
...
<?php /**PATH /home/cnfbr/laravel_teste/resources/views/scripts/formasDePagamento.blade.php ENDPATH**/ ?>