<section class="container mt-2 pag-txt">
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="tab-content" id="forma-de-pagamento-escolhido">
                    ...
                    <div class="mb-3">
                        <form id="form-boleto" class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="nomeboleto" value="<?php echo e(old('nomeboleto')); ?>" type="text"
                                class="form-control"
                ...
                <div class="tab-pane fade" id="cartao-credito" role="tabpanel"
                    ...
                    <?php echo $__env->make('forms.dadosCartao', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <div class="tab-pane fade" id="banco-do-brasil" role="tabpanel" aria-labelledby="banco-do-brasil-tab">
                    <div class="mb-3">
                        <p class="text-danger">É necessário o envio de comprovante de pagamento para
                            <strong><?php echo e(config('constants.emails')['financeiro']); ?></strong></p>
                        <div id="pre-bb">
                        ...
                        <div id="confirmado-bb" class="d-none row gx-0" style="overflow:hidden;">
                            <div class="col-lg-8 col-12 mb-3 text-break">
                                <?php $__currentLoopData = $dadosBancariosBB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chave => $valor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <p class="mb-1"><?php echo e($chave); ?>: <strong><?php echo e($valor); ?></strong></p>
                            ...
                            <div class="col-lg-4 col-12 d-flex justify-content-center">
                                <div style="max-width:250px; width:100%; aspect-ratio:1/1; display:flex; justify-content:center; align-items:center;">                                
                                    <!-- <img class="mw-100" src="<?php echo e(asset('images/qrcode-pix-bb.jpeg')); ?>" alt="" title="QR Code PIX Banco do Brasil"> -->
                                    <img class="d-block mx-auto" src="<?php echo e(asset('images/QRCodeBB_CNF_TEC.jpg')); ?>" alt="" title="QR Code PIX BB CNF TEC" style="display:block; width:100%; height:100%; object-fit:contain;">
                                </div>                                
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-6 py-3 py-md-0">
            ...
            <div>
                <p>ID da solicitação:<br/><strong><?php echo e($solicitacao['sol_id']); ?></strong></p>
                <p>Cliente:<br/><strong><?php echo e(!empty($solicitacao['sol_empresa']) ? $solicitacao['sol_empresa'] : $solicitacao['sol_nome_sol']); ?> <br> (<?php echo e($solicitacao['sol_email_sol']); ?>)</strong></p>
                <p>Produto:<br/><strong><?php echo e($solicitacao['produto']); ?></strong></p>
                <p>Valor:<br/><strong><?php echo e($solicitacao['sol_valor']); ?></strong></p>
...
<?php /**PATH /home/cnfbr/laravel_teste/resources/views/partials/formasDePagamento.blade.php ENDPATH**/ ?>