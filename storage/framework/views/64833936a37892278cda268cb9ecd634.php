<form class="modal-content modal1" action="<?php echo e(route('receptor-comunicado-de-erro')); ?>" method="POST">
  <?php echo csrf_field(); ?>
  ...
  <div class="modal-body">
    ...
    <input type="hidden" name="data_falecimento" id="dataFal">
      ...
      <div class="mb-3">
          ...
          <input type="email" name="email_comunicante" class="form-control" id="email_comunicante" required value="<?php echo e(old('email_comunicante')); ?>">
      </div>

      <div class="mb-3">
          <label for="nome_comunicante" class="col-form-label">Seu nome:</label>
          <input type="text" name="nome_comunicante" class="form-control" id="nome_comunicante" required value="<?php echo e(old('nome_comunicante')); ?>">
      </div>
      ...
      <div class="mb-3">
          ...
          <textarea name="mensagem" class="form-control" id="mensagem" rows="3" required><?php echo e(old('mensagem')); ?></textarea>
      </div>
  </div>
...
</form><?php /**PATH /home/cnfbr/laravel_teste/resources/views/forms/reportarErro.blade.php ENDPATH**/ ?>