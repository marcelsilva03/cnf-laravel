...
<section class="pt-5 d-flex align-items-center justify-content-center" style="min-height: 90vh">
    <div class="m-auto pt-5" style="max-width: 400px">
        ...
        <div class="tab-content espaco_tab">
            <form class="row g-3" action="<?php echo e(route('usuario.recebe-esqueci-senha')); ?>" method="POST" id="pesquisaForm">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /home/cnfbr/laravel_teste/resources/views/usuario/forms/esqueci-senha.blade.php ENDPATH**/ ?>